/*
  ...
  - You are about to drop the column `supplierContentHtml` on the `offers` table. All the data in the column will be lost.
  - You are about to drop the column `supplierContentTitle` on the `offers` table. All the data in the column will be lost.
  - You are about to drop the column `supplierEmail` on the `offers` table. All the data in the column will be lost.
  - Added the required column `supplierContactId` to the `SupplierOffer` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_SupplierOffer" (
    ...
    CONSTRAINT "SupplierOffer_supplierContactId_fkey" FOREIGN KEY ("supplierContactId") REFERENCES "supplier_contacts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
