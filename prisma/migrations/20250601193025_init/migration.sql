...
INSERT INTO "new_offers" ("calculatedLdm", "calculatedVolume", "containerDimensions", "containerType", "createdAt", "customs", "deletedAt", "deliveryCity", "deliveryCountry", "deliveryDate", "deliveryPostalCode", "foreignTrade", "goodsType", "id", "isStackable", "loadCity", "loadCountry", "loadDate", "numOfContainers", "offerNo", "packagingType", "status", "updatedAt") SELECT "calculatedLdm", "calculatedVolume", "containerDimensions", "containerType", "createdAt", "customs", "deletedAt", "deliveryCity", "deliveryCountry", "deliveryDate", "deliveryPostalCode", "foreignTrade", "goodsType", "id", "isStackable", "loadCity", "loadCountry", "loadDate", "numOfContainers", "offerNo", "packagingType", "status", "updatedAt" FROM "offers";
DROP TABLE "offers";
